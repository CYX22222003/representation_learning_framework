# TA-MLP Baseline — Triclass Run (v1, epochs=50)

**Date:** 2026-06-22
**Run name:** `2026-06-22-v1/e50`
**Script:** `src/baselines/ta_mlp_baseline/ta_mlp_model.py --run-name 2026-06-22-v1/e50 --epochs 50 --seed 0 --label-mode triclass`
**Plotting:** `src/baselines/ta_mlp_baseline/plot_experiment.py experiments/2026-06-22-v1/e50`
...
|---|---|---|---|
| BUY  | 0.2337 | 0.3757 | 0.2881 |
| HOLD | 0.8400 | 0.8690 | 0.8542 |
| SELL | 0.3898 | 0.1616 | 0.2285 |
